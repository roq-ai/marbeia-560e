  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to MarbeIA - Your ultimate platform for viewing lists and tops of the latest NFT play-to-earn games. Earn rewards while viewing ads!"
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1644361566696-3d442b5b482a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxqdWVnb3MlMjBuZnR8ZW58MHx8fHwxNjg5OTkwNDYxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to MarbeIA - Your ultimate platform for viewing lists and tops of the latest NFT play-to-earn games. Earn rewards while viewing ads!`}
            </Text>
            <Box
